...
class dataPlotter:
    def __init__(self):
        ...
        self.theta_ref_history = []  # reference position
        self.theta_history = []  # position z
        self.torque_history = []  # control force

        # create a handle for every subplot.
        self.handle = []
        self.handle.append(myPlot(self.ax[0], ylabel='theta(rad)', title='Angle'))
        self.handle.append(myPlot(self.ax[1], xlabel='t(s)', ylabel='torque(Nm)'))
    ...
    def update(self, t, reference, states, ctrl):
        ...
        self.theta_ref_history.append(reference)  # reference mass position
        self.theta_history.append(states.item(0))  # mass position
